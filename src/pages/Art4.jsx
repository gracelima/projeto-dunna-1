    ...
    return (
      <>
        ...
        <div className={styles.container}>
          ...
          <h1 className={styles.nome}>Duda Art
        ...
        <img className={styles.images} src="./illustration/artista4/5art4.png" alt="" />
        <img className={styles.images} src="./illustration/artista4/3art4.png" alt="" />
        <img className={styles.images} src="./illustration/artista4/4art4.png" alt="" />
        <img className={styles.images} src="./illustration/artista4/2art4.jpg" alt="" />
        <img className={styles.images} src="./illustration/artista4/6art4.png" alt="" />
        <img className={styles.images} src="./illustration/artista4/7art4.jpg" alt="" />
        <img className={styles.images} src="./illustration/artista4/8art4.png" alt="" />
          </div> }
