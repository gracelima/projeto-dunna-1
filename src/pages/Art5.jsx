    ...
    return (
      <>
        ...
        <div className={styles.container}>
          ...
          <h1 className={styles.nome}>Davi Morais
         ...
         <img className={styles.images} src="./illustration/artista5/2art5.jpeg" alt="" />
         <img className={styles.images} src="./illustration/artista5/3art5.jpeg" alt="" />
         <img className={styles.images} src="./illustration/artista5/4art5.jpeg" alt="" />
         <img className={styles.images} src="./illustration/artista5/5art5.jpeg" alt="" />
         <img className={styles.images} src="./illustration/artista5/6art5.jpeg" alt="" />
